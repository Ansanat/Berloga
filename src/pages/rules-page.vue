...
<div class="v-rules-page" id="rules-page">
  ...
  <div class="rules-position">
    ...
    <div class="rules">2. Дети до 16 лет (включительно) допускаются в Баню только в сопровождении взрослых.</div>
    <div class="rules">3. Дети до 5 лет (включительно) посещение бесплатное.</div> 
  ...
  <div class="rules-position">
    ...
    <div class="rules">14. Производить расчет за оказанные услуги в любом месте и любому сотруднику Бани за исключением стойки кассира на стойке ресепшен по предъявлению персонального чипа-браслета.</div>
    <div class="rules">15. Выходить на улицу в одной простыни и тапочках</div>
    <div class="rules">16. Надевать персональный чип-браслет на ногу</div>
    <div class="rules">17. Использовать свое опахало или веер</div>
    <div class="rules">18. Использовать индивидуальную парную без заказа индивидуального парения</div>
    <div class="rules">19. Заниматься реализацией товаров и услуг</div>
  </div>
  <div class="rules-position">
  ...
  <div class="rules-position">
    ...
    <div class="rules">- По системе лояльность начисляются бонусы только за один браслет оплаченный гостем. Исключением является Отец+сын или Мать + дочь.</div>
  </div>
</div>
</template>
